...
class Visualization():
    ...
    def make_label_vis(self, output_dir, epochs_passed):
        ...
        sm._A = []
        cb = plt.colorbar(sm)
        #cb.set_label('predicted class', labelpad=-10, y=1, rotation=0)
        ...
        #plt.title(f"Activations of all 100 neurons in the CNN's first fully connected layer, reduced to 2 dimensions using UMAP")
